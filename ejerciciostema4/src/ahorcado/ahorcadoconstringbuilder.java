...
public class ahorcadoconstringbuilder {
	//propiedades
		...
		private StringBuilder palabraIntentada; //almacena todos los caracteres se puede utilizar el stringbuilder
		private StringBuilder letrasProbadas; //para mostrar las letras utilizadas
		private int fallos;
		
		
		//elige de forma aleatoria una palabra del diccionario
		public ahorcadoconstringbuilder() {
